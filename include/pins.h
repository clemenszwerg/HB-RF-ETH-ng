/*
 *  pins.h is part of the HB-RF-ETH firmware v2.0
 *
...
#define SUPPLY_VOLTAGE_SENSE_CHANNEL ((adc_channel_t)ADC1_GPIO37_CHANNEL)
#define SUPPLY_VOLTAGE_SENSE_UNIT ADC_UNIT_1
