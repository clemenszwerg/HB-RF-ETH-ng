...
// Local translations (only de + en are defined; other locales fall back to en).
// Kept local to avoid bloating the SPIFFS locale bundles — see i18n revert note.
const translations = {
  de: {
    eyebrow: 'Diagnose',
    ...
    usedRam: 'RAM belegt',
    totalRam: 'RAM gesamt',
    minimumHeap: 'RAM-Minimum',
    largestBlock: 'Größter Block',
    flash: 'Flash',
    currentAvailable: 'Aktuell verfügbar',
    allocatableRam: 'Vom Heap nutzbarer interner RAM',
    sinceBoot: 'Niedrigster Wert seit Start',
    contiguous: 'Größte zusammenhängende Allokation',
    physicalFlash: 'Erkannter Flash-Speicher',
    runtime: 'Laufzeitumgebung',
    runtimeHint: 'ESP-IDF, Hardware und letzter Neustart',
    idf: 'ESP-IDF',
    ...
    partitions: 'OTA-Partitionen',
    partitionsHint: 'Aktive und nächste Firmware-Partition',
    runningPartition: 'Aktiv',
    runningSize: 'Aktive Größe',
    nextPartition: 'Nächstes Update',
    nextSize: 'Update-Größe',
    webuiHint: 'Quelle und Speicher des New Designs',
    source: 'Quelle',
    version: 'Version',
    partitionSize: 'Partitionsgröße',
    used: 'Belegt',
    logs: 'Log-Puffer',
    logsHint: 'Speicher, Crash-Tail und aktive Live-Streams',
    capture: 'Aufzeichnung',
    active: 'Aktiv',
    inactive: 'Inaktiv',
    bufferSize: 'Puffergröße',
    availableLogs: 'Gespeicherte Logs',
    totalStream: 'Gesamt geschrieben',
    subscribers: 'Subscriber',
    crashTail: 'Crash-Tail',
    available: 'Vorhanden',
  ...
  en: {
    ...
    allocatableRam: 'Internal RAM available to the heap',
    sinceBoot: 'Lowest value since boot',
    contiguous: 'Largest contiguous allocation',
    physicalFlash: 'Detected flash storage',
    runtime: 'Runtime',
    runtimeHint: 'ESP-IDF, hardware and last restart',
    idf: 'ESP-IDF',
    target: 'Target',
    cores: 'CPU cores',
    chipRevision: 'Chip revision',
    ...
    partitions: 'OTA partitions',
    partitionsHint: 'Running and next firmware partition',
    runningPartition: 'Running',
    runningSize: 'Running size',
    nextPartition: 'Next update',
    nextSize: 'Update size',
    webuiHint: 'New Design source and storage',
    source: 'Source',
    version: 'Version',
    partitionSize: 'Partition size',
    used: 'Used',
    logs: 'Log buffer',
    logsHint: 'Memory, crash tail and active live streams',
    capture: 'Capture',
    active: 'Active',
    inactive: 'Inactive',
    bufferSize: 'Buffer size',
    availableLogs: 'Buffered logs',
    totalStream: 'Total written',
