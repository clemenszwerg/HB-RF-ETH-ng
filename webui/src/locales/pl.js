export default {
  ...
  firmware: {
    ...
    versionInfo: 'Zmodernizowany fork v2.2.3-Beta.28 autorstwa Xerolux (2025) - Na podstawie oryginalnej pracy Alexandra Reinerta.',
    ...
    archiveUsingCache: 'GitHub jest teraz niedostępny. Wyświetlana jest ostatnio zapisana lista archiwum z {time}.',
  ...
  systemlog: {
    ...
    share: 'Udostępnij',
    shareTitle: 'Udostępnij log',
    shareLoading: 'Przesyłanie logu do usługi udostępniania...',
    shareHint: 'Wyślij ten link, aby udostępnić swój log. Każdy, kto ma link, może go wyświetlić.',
    shareCopied: 'Link udostępniania skopiowany do schowka',
    shareFailed: 'Nie udało się udostępnić logu. Spróbuj ponownie.',
    shareCopy: 'Kopiuj link',
    shareCopyManual: 'Nie można skopiować automatycznie — link jest zaznaczony, skopiuj go ręcznie.',
