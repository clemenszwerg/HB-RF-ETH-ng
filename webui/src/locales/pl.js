export default {
  ...
  systemOverview: {
    ...
    subtitle: 'RAM, flash, partycje, logi i aktywny interfejs web w jednym rzucie oka.',
    freeRam: 'RAM wolny',
    usedRam: 'RAM zajęty',
    totalRam: 'RAM całkowity',
    minimumHeap: 'Minimum RAM',
    largestBlock: 'Największy blok',
    flash: 'Flash',
    currentAvailable: 'Obecnie dostępne',
    allocatableRam: 'Pamięć RAM wewnętrzna dostępna dla sterty',
    sinceBoot: 'Najniższa wartość od uruchomienia',
    contiguous: 'Największa ciągła alokacja',
    physicalFlash: 'Wykryta pamięć flash',
    runtime: 'Środowisko uruchomieniowe',
    runtimeHint: 'ESP-IDF, sprzęt i ostatni restart',
    idf: 'ESP-IDF',
    target: 'Platforma docelowa',
    cores: 'Rdzenie CPU',
    chipRevision: 'Rewizja układu',
    resetReason: 'Ostatni powód resetu',
    psram: 'PSRAM',
    psramTotal: 'PSRAM całkowity',
    psramFree: 'PSRAM wolny',
    partitions: 'Partycje OTA',
    partitionsHint: 'Aktywna i następna partycja oprogramowania',
    runningPartition: 'Aktywna',
    runningSize: 'Rozmiar aktywnej',
    nextPartition: 'Następna aktualizacja',
    nextSize: 'Rozmiar aktualizacji',
    webuiHint: 'Źródło i pamięć nowego designu',
    source: 'Źródło',
    version: 'Wersja',
    partitionSize: 'Rozmiar partycji',
    used: 'Zajęte',
    logs: 'Bufor logów',
    logsHint: 'Pamięć, crash tail i aktywne strumienie na żywo',
    capture: 'Przechwytywanie',
    active: 'Aktywne',
    inactive: 'Nieaktywne',
    bufferSize: 'Rozmiar bufora',
    availableLogs: 'Zapisane logi',
    totalStream: 'Łącznie zapisano',
    subscribers: 'Subskrybenci',
    crashTail: 'Crash tail',
    available: 'Dostępne',
    notAvailable: 'Niedostępne',
    onDemandHint: 'Wszystkie wartości są odczytywane tylko przy otwarciu lub ręcznym odświeżeniu. Niezależna strona awaryjna jest dostępna pod',
    refresh: 'Odśwież'
  },
  ...
  webuiUpdate: {
    ...
    updateAvailableTitle: 'Aktualizacja dostępna',
    updateAvailableMessage: 'Wersja WebUI {version} jest dostępna.',
    skippedTitle: 'Sprawdzanie pominięte',
    skippedMessage: 'Urządzenie pominęło sprawdzanie z powodu zbyt małej ilości wolnej pamięci. Zdarza się to zazwyczaj, gdy aktywna jest sesja CCU — spróbuj ponownie później.',
    upToDateTitle: 'Wszystko aktualne',
    upToDateMessage: 'Brak dostępnej nowszej WebUI.',
    cooldownTitle: 'Chwila cierpliwości',
    cooldownMessage: 'Sprawdzanie już trwa lub blokada 60 sekund jest nadal aktywna.',
    checkFailedTitle: 'Sprawdzanie nie powiodło się',
    checkFailedMessage: 'Nie udało się przeprowadzić sprawdzania aktualizacji.',
  ...
  firmware: {
    ...
    versionInfo: 'Zmodernizowany fork v2.2.5-Beta.8 autorstwa Xerolux (2025) - Na podstawie oryginalnej pracy Alexandra Reinerta.',
