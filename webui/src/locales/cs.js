export default {
  ...
  systemOverview: {
    ...
    subtitle: 'RAM, flash, oddíly, protokoly a aktivní webové rozhraní přehledně.',
    freeRam: 'RAM volná',
    usedRam: 'RAM obsazena',
    totalRam: 'RAM celkem',
    minimumHeap: 'Minimum RAM',
    largestBlock: 'Největší blok',
    flash: 'Flash',
    currentAvailable: 'Aktuálně k dispozici',
    allocatableRam: 'Interní RAM dostupná pro haldu',
    sinceBoot: 'Nejnižší hodnota od spuštění',
    contiguous: 'Největší souvislá alokace',
    physicalFlash: 'Detekované úložiště flash',
    runtime: 'Běhové prostředí',
    runtimeHint: 'ESP-IDF, hardware a poslední restart',
    idf: 'ESP-IDF',
    target: 'Cílová platforma',
    cores: 'Jader CPU',
    chipRevision: 'Revize čipu',
    resetReason: 'Důvod posledního resetu',
    psram: 'PSRAM',
    psramTotal: 'PSRAM celkem',
    psramFree: 'PSRAM volná',
    partitions: 'OTA oddíly',
    partitionsHint: 'Aktivní a další oddíl firmwaru',
    runningPartition: 'Aktivní',
    runningSize: 'Velikost aktivního',
    nextPartition: 'Další aktualizace',
    nextSize: 'Velikost aktualizace',
    webuiHint: 'Zdroj a úložiště nového designu',
    source: 'Zdroj',
    version: 'Verze',
    partitionSize: 'Velikost oddílu',
    used: 'Obsazeno',
    logs: 'Vyrovnávací paměť protokolu',
    logsHint: 'Paměť, crash tail a aktivní živé streamy',
    capture: 'Záznam',
    active: 'Aktivní',
    inactive: 'Neaktivní',
    bufferSize: 'Velikost vyrovnávací paměti',
    availableLogs: 'Uložené protokoly',
    totalStream: 'Celkem zapsáno',
    subscribers: 'Odběratelé',
    crashTail: 'Crash tail',
    available: 'K dispozici',
    notAvailable: 'Není k dispozici',
    onDemandHint: 'Všechny hodnoty se čtou pouze při otevření nebo ruční aktualizaci. Nezávislá stránka nouze je dostupná na',
  ...
  webuiUpdate: {
    ...
    updateAvailableMessage: 'Verze WebUI {version} je dostupná.',
    skippedTitle: 'Kontrola přeskočena',
    skippedMessage: 'Zařízení přeskočilo kontrolu kvůli nedostatku volné paměti. Stává se to obvykle při aktivní relaci CCU — zkuste to později znovu.',
    upToDateTitle: 'Vše je aktuální',
    upToDateMessage: 'Není k dispozici novější WebUI.',
    cooldownTitle: 'Chviličku počkejte',
    cooldownMessage: 'Kontrola již probíhá nebo je stále aktivní 60sekundová blokace.',
    checkFailedTitle: 'Kontrola selhala',
    checkFailedMessage: 'Kontrolu aktualizací se nepodařilo provést.',
  ...
  firmware: {
    ...
    versionInfo: 'Modernizovaný fork v2.2.5-Beta.8 od Xerolux (2025) - Založeno na původní práci Alexandra Reinerta.',
