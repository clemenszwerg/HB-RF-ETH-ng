export default {
  ...
  firmware: {
    ...
    versionInfo: 'Modernizovaný fork v2.2.3-Beta.28 od Xerolux (2025) - Založeno na původní práci Alexandra Reinerta.',
  ...
  systemlog: {
    ...
    share: 'Sdílet',
    shareTitle: 'Sdílet log',
    shareLoading: 'Nahrávání logu do služby sdílení...',
    shareHint: 'Pošlete tento odkaz pro sdílení logu. Kdokoli s odkazem si ho může prohlédnout.',
    shareCopied: 'Odkaz na sdílení zkopírován do schránky',
    shareFailed: 'Nepodařilo se sdílet log. Zkuste to prosím znovu.',
    shareCopy: 'Kopírovat odkaz',
    shareCopyManual: 'Automatické kopírování se nezdařilo — odkaz je vybraný, zkopírujte jej ručně.',
