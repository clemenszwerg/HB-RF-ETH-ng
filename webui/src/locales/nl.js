export default {
  ...
  login: {
    ...
    passwordResetTitle: 'Wachtwoord opnieuw instellen',
    passwordResetPressButton: 'Druk nu kort op de HM-knop op het bord (GPIO34 / HM_BTN) om te bevestigen dat u fysieke toegang hebt.',
    passwordResetExpires: 'Tijdvenster: {seconds} seconden',
    passwordResetConfirmed: 'Bordknop gedetecteerd',
    passwordResetEnterNew: 'Stel nu een nieuw beheerderswachtwoord in.',
    newPasswordPlaceholder: 'Nieuw wachtwoord',
    confirmPasswordPlaceholder: 'Herhaal nieuw wachtwoord',
    passwordResetSave: 'Wachtwoord opslaan',
    passwordResetPolicy: 'Gebruik 8 tot maximaal 32 tekens met hoofdletters, kleine letters en een cijfer.',
    passwordResetMismatch: 'De wachtwoorden komen niet overeen.',
    passwordResetExpired: 'Het tijdvenster is verstreken. Start de procedure opnieuw.',
    passwordResetError: 'Wachtwoord opnieuw instellen is mislukt.',
  ...
  settings: {
    ...
    showExperimental: 'Experimentele functies tonen',
    showExperimentalHint: 'Toont experimentele menu-items, tabbladen en instellingen. Opgeslagen experimentele waarden blijven behouden bij verbergen.',
    showExperimentalWarning: 'Experimentele functies zijn onafgemaakt en kunnen veranderen of niet naar behoren werken.',
    showExperimentalOn: 'Experimentele functies getoond',
    showExperimentalOff: 'Experimentele functies verborgen',
    ...
    experimentalEmptyTitle: 'Nog niets beschikbaar',
    experimentalEmptyText: 'Er zijn momenteel geen experimentele functies beschikbaar. Het nieuwe ontwerp en de herstart-synchronisatie zijn standaard voor alle apparaten.',
  ...
  systemOverview: {
    ...
    subtitle: 'RAM, flash, partities, logs en actieve webinterface in één oogopslag.',
    freeRam: 'RAM vrij',
    usedRam: 'RAM gebruikt',
    totalRam: 'RAM totaal',
    minimumHeap: 'RAM-minimum',
    largestBlock: 'Grootste blok',
    flash: 'Flash',
    currentAvailable: 'Momenteel beschikbaar',
    allocatableRam: 'Interne RAM beschikbaar voor de heap',
    sinceBoot: 'Laagste waarde sinds opstarten',
    contiguous: 'Grootste aaneengesloten toewijzing',
    physicalFlash: 'Gedetecteerde flashopslag',
    runtime: 'Runtime-omgeving',
    runtimeHint: 'ESP-IDF, hardware en laatste herstart',
    idf: 'ESP-IDF',
    target: 'Doelplatform',
    cores: 'CPU-kernen',
    chipRevision: 'Chiprevisie',
    resetReason: 'Laatste resetreden',
    psram: 'PSRAM',
    psramTotal: 'PSRAM totaal',
    psramFree: 'PSRAM vrij',
    partitions: 'OTA-partities',
    partitionsHint: 'Actieve en volgende firmwarepartitie',
    runningPartition: 'Actief',
    runningSize: 'Actieve grootte',
    nextPartition: 'Volgende update',
    nextSize: 'Update-grootte',
    webuiHint: 'Bron en opslag van het nieuwe ontwerp',
    source: 'Bron',
    version: 'Versie',
    partitionSize: 'Partitiegrootte',
    used: 'Gebruikt',
    logs: 'Logbuffer',
    logsHint: 'Geheugen, crash-tail en actieve live streams',
    capture: 'Opname',
    active: 'Actief',
    inactive: 'Inactief',
    bufferSize: 'Buffergrootte',
    availableLogs: 'Opgeslagen logs',
    totalStream: 'Totaal geschreven',
    subscribers: 'Abonnees',
    crashTail: 'Crash-tail',
    available: 'Beschikbaar',
    notAvailable: 'Niet beschikbaar',
    onDemandHint: 'Alle waarden worden alleen gelezen bij het openen of handmatig vernieuwen. De onafhankelijke noodpagina is bereikbaar op',
    refresh: 'Vernieuwen'
  },
  ...
  updates: {
    ...
    checkResultUpdated: 'Versie {version} is beschikbaar.',
    checkResultNoUpdateTitle: 'Alles is actueel',
    checkResultNoUpdate: 'Er is geen nieuwere versie beschikbaar.',
    checkResultErrorTitle: 'Controle mislukt',
    checkResultError: 'De update-controle kon niet worden uitgevoerd.',
    checkResultCooldownTitle: 'Even geduld',
    checkResultCooldown: 'Er loopt al een controle of de blokkering van 60 seconden is nog actief.',
    checkResultSkippedTitle: 'Controle overgeslagen',
    checkResultSkipped: 'Het apparaat heeft de controle overgeslagen wegens te weinig vrij geheugen. Dit gebeurt meestal terwijl een CCU-sessie actief is — probeer het later opnieuw.'
  },

  // WebUI-updatepagina (apart WebUI-tabblad)
  webuiUpdate: {
    pageTitle: 'Webinterface bijwerken',
    pageSubtitle: 'Firmware en WebUI hebben afzonderlijke versies. De installatie gebeurt uitsluitend via een handmatig geselecteerde 320 KB WWW-image.',
    webuiChip: 'WebUI',
    firmwareChip: 'Firmware',
    separateActive: 'Afzonderlijke WebUI actief',
    embeddedFallback: 'Ingebouwde fallback actief',
    installedLabel: 'Geïnstalleerde WebUI-versie',
    separateSource: 'Vanuit de afzonderlijke WWW-partitie',
    embeddedSource: 'Ingebouwd in de firmware',
    storageLabel: 'WWW-opslag',
    checkLabel: 'Update-controle',
    checkHint: 'Online controle maximaal één keer per 24 uur',
    availableKicker: 'Beschikbare WebUI',
    downloadHeading: 'WebUI-bestand downloaden',
    downloadHelp: 'De ESP downloadt alleen het kleine gedeelde update-manifest. Het BIN-bestand wordt rechtstreeks door je browser gedownload.',
    installedGridLabel: 'Geïnstalleerd',
    availableGridLabel: 'Beschikbaar',
    imageSizeLabel: 'Imagegrootte',
    minFirmwareLabel: 'Firmware minimaal',
    upToDate: 'De geïnstalleerde WebUI is actueel.',
    downloadButton: 'WebUI-BIN downloaden',
    releaseLink: 'Release op GitHub',
    reloadStatusButton: 'Opgeslagen status opnieuw laden',
    manualKicker: 'Handmatige installatie',
    uploadHeading: 'WWW-image uploaden',
    uploadHelp: 'Gebruik hier uitsluitend webui_*.bin of spiffs.bin met exact {size}.',
    chooseFile: 'WebUI-BIN kiezen',
    uploadInProgress: 'WebUI wordt overgebracht …',
    uploadExplainer: 'Het apparaat controleert de partitiegrootte, het interne manifest en optioneel SHA-256. Als de image ongeldig of onvolledig is, blijft het ingebouwde New Design actief als fallback.',
    installingButton: 'WebUI wordt geïnstalleerd …',
    installButton: 'WebUI installeren',
    clearSelectionButton: 'Selectie wissen',
    unknownVersion: 'onbekend',
    neverChecked: 'Nog niet gecontroleerd',
    statusLoadError: 'Apparaatstatus kon niet worden geladen.',
    manifestNoWebui: 'Het opgeslagen update-manifest bevat nog geen afzonderlijk WebUI-bestand.',
    manifestWrongDesign: 'De aangeleverde WebUI-image behoort niet tot het New Design.',
    manifestWrongSize: 'De aangeboden WebUI heeft de verkeerde grootte. Verwacht: {expected}.',
    manifestWrongApi: 'Deze WebUI vereist een andere firmware-API.',
    manifestFirmwareTooOld: 'De firmware is te oud. Minimaal vereist: {min}.',
    manifestLoadError: 'Opgeslagen update-status kon niet worden geladen.',
    updateAvailableTitle: 'Update beschikbaar',
    updateAvailableMessage: 'WebUI-versie {version} is beschikbaar.',
    skippedTitle: 'Controle overgeslagen',
    skippedMessage: 'Het apparaat heeft de controle overgeslagen wegens te weinig vrij geheugen. Dit gebeurt meestal terwijl een CCU-sessie actief is — probeer het later opnieuw.',
    upToDateTitle: 'Alles actueel',
    upToDateMessage: 'Er is geen recentere WebUI beschikbaar.',
    cooldownTitle: 'Even geduld',
    cooldownMessage: 'Er loopt al een controle of de blokkering van 60 seconden is nog actief.',
    checkFailedTitle: 'Controle mislukt',
    checkFailedMessage: 'De update-controle kon niet worden uitgevoerd.',
    fileInvalidExtension: 'Ongeldig bestand: een WebUI-image met de extensie .bin is vereist.',
    fileIsFirmware: 'Verkeerd bestand: dit is een firmwarebestand. Installeer het onder Systeem → Firmware.',
    fileStatusMissing: 'Apparaatstatus niet beschikbaar. Voer eerst „Opgeslagen status opnieuw laden” uit en probeer het opnieuw.',
    fileWrongSize: 'Verkeerde imagegrootte: exact {expected} ({bytes} bytes) verwacht.',
    installSuccessTitle: 'WebUI geïnstalleerd',
    installSuccessMessage: 'Actieve WebUI-versie: {version}',
    uploadFailedTitle: 'WebUI-upload mislukt',
    uploadFailedMessage: 'WebUI-upload mislukt.'
  },
  ...
  firmware: {
    ...
    factoryResetMessage: 'Wilt u echt alle instellingen terugzetten naar de fabrieksinstellingen?',
    factoryResetWarning: 'Alle opgeslagen instellingen gaan verloren. Het apparaat start daarna automatisch opnieuw op.',
    factoryResetConfirm: 'Terugzetten naar fabrieksinstellingen',
    factoryResetError: 'Terugzetten naar fabrieksinstellingen is mislukt.',
  ...
  monitoring: {
    ...
    resourceWarningTitle: 'Houd de bronnen in de gaten',
    resourceWarningText: 'Er zijn {count} monitoringsdiensten actief. De ESP32 kan dit normaliter aan, maar gelijktijdige TLS-verbindingen, firmwarecontroles/archiefopvragingen en OTA delen heap en CPU; schakel bij problemen afzonderlijke diensten uit of verspreid tests over de tijd.',
    save: 'Opslaan',
    saving: 'Opslaan...',
  ...
  systemlog: {
    ...
    crashTitle: 'Crashlog hersteld',
    crashHint: 'Het apparaat is opnieuw opgestart na een watchdog-reset of systeemfout. Dit overzicht van de laatste logregels is vlak voor de herstart bewaard en is na sluiten niet meer beschikbaar.'
  },
