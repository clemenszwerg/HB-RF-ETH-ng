export default {
  ...
  // System Overview page (dashboard / Diagnose)
  systemOverview: {
    eyebrow: 'Diagnose',
  ...
  webuiUpdate: {
    ...
    pageSubtitle: 'Firmware und WebUI besitzen getrennte Versionen. Die Installation erfolgt ausschließlich über ein manuell ausgewähltes 320-KB-WWW-Image.',
    webuiChip: 'WebUI',
    ...
    updateAvailableMessage: 'WebUI-Version {version} ist verfügbar.',
    skippedTitle: 'Prüfung übersprungen',
    skippedMessage: 'Das Gerät hat die Prüfung wegen zu wenig freiem Arbeitsspeicher übersprungen. Tritt meist bei aktiver CCU-Sitzung auf — später erneut versuchen.',
    upToDateTitle: 'Alles aktuell',
    upToDateMessage: 'Es ist keine neuere WebUI vorhanden.',
    cooldownTitle: 'Kurz gewartet',
    cooldownMessage: 'Es läuft bereits eine Prüfung oder die 60-Sekunden-Sperre ist noch aktiv.',
    checkFailedTitle: 'Prüfung fehlgeschlagen',
    checkFailedMessage: 'Die Update-Prüfung konnte nicht durchgeführt werden.',
  ...
  firmware: {
    ...
    versionInfo: 'Modernisierte Fork v2.2.5-Beta.8 von Xerolux (2025) - Basierend auf der Original-Arbeit von Alexander Reinert.',
