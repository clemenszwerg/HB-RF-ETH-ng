export default {
  ...
  webuiUpdate: {
    ...
    updateAvailableMessage: 'WebUI version {version} is available.',
    skippedTitle: 'Check skipped',
    skippedMessage: 'The device skipped the check because of low free memory. This usually happens while a CCU session is active — please try again later.',
    upToDateTitle: 'Everything is up to date',
    upToDateMessage: 'No newer WebUI is available.',
    cooldownTitle: 'Just a moment',
    cooldownMessage: 'A check is already running or the 60-second cooldown is still active.',
  ...
  firmware: {
    ...
    versionInfo: 'Modernized fork v2.2.5-Beta.8 by Xerolux (2025) - Based on the original work by Alexander Reinert.',
