export default {
  ...
  firmware: {
    ...
    versionInfo: 'Modernized fork v2.1.11 by Xerolux (2025) - Based on the original work by Alexander Reinert.',
  ...
  about: {
    ...
    forkDescription: 'This version is a modernized fork by Xerolux (2025), based on the original HB-RF-ETH firmware. Updated to ESP-IDF 5.x, modern toolchains and current WebUI technologies (Vue 3, Vite, Pinia).',
