export default {
  ...
  updates: {
    ...
    firmware: 'Enhetsfastvare',
    firmwareDescription: 'ESP32, nettverk og radio',
    webui: 'WebUI',
    webuiDescription: 'Kontrollflate i nettleseren',
  ...
  firmware: {
    ...
    versionInfo: 'Modernisert fork v2.2.5-Beta.12 av Xerolux (2025) - Basert på originalarbeidet til Alexander Reinert.',
