export default {
  ...
  login: {
    ...
    passwordResetPressButton: 'Trykk kort på HM-knappen på kortet nå (GPIO34 / HM_BTN) for å bekrefte fysisk tilgang.',
    passwordResetExpires: 'Tidsvindu: {seconds} sekunder',
    passwordResetConfirmed: 'Kort-knapp oppdaget',
    passwordResetEnterNew: 'Vennligst angi et nytt administratorpassord nå.',
    newPasswordPlaceholder: 'Nytt passord',
    confirmPasswordPlaceholder: 'Gjenta nytt passord',
    passwordResetSave: 'Lagre passord',
    passwordResetPolicy: 'Minst 8 til maksimalt 32 tegn med store bokstaver, små bokstaver og tall.',
    passwordResetMismatch: 'Passordene samsvarer ikke.',
    passwordResetExpired: 'Tidsvinduet er utløpt. Vennligst start på nytt.',
    passwordResetError: 'Tilbakestilling av passord mislyktes.',
  ...
  settings: {
    ...
    showExperimental: 'Vis eksperimentelle funksjoner',
    showExperimentalHint: 'Viser eksperimentelle menyoppføringer, faner og innstillinger. Lagrede eksperimentelle verdier beholdes når de skjules igjen.',
    showExperimentalWarning: 'Eksperimentelle funksjoner er uferdige og kan endres eller ikke fungere som forventet.',
    showExperimentalOn: 'Eksperimentelle funksjoner vist',
    showExperimentalOff: 'Eksperimentelle funksjoner skjult',
    ...
    experimentalEmptyTitle: 'Ingenting her ennå',
    experimentalEmptyText: 'Det er for øyeblikket ingen eksperimentelle funksjoner tilgjengelig. Nytt design og Omstart-synk. er standard for alle enheter.',
  ...
  systemOverview: {
    ...
    subtitle: 'RAM, flash, partisjoner, logger og aktiv webgrensesnitt med ett blikk.',
    freeRam: 'RAM ledig',
    usedRam: 'RAM brukt',
    totalRam: 'RAM totalt',
    minimumHeap: 'RAM-minimum',
    largestBlock: 'Største blokk',
    flash: 'Flash',
    currentAvailable: 'Tilgjengelig nå',
    allocatableRam: 'Intern RAM tilgjengelig for heapen',
    sinceBoot: 'Laveste verdi siden oppstart',
    contiguous: 'Største sammenhengende allokering',
    physicalFlash: 'Oppdaget flashlagring',
    runtime: 'Kjøretidsmiljø',
    runtimeHint: 'ESP-IDF, maskinvare og siste omstart',
    idf: 'ESP-IDF',
    target: 'Målplattform',
    cores: 'CPU-kjerner',
    chipRevision: 'Chip-revisjon',
    resetReason: 'Siste reset-årsak',
    psram: 'PSRAM',
    psramTotal: 'PSRAM totalt',
    psramFree: 'PSRAM ledig',
    partitions: 'OTA-partisjoner',
    partitionsHint: 'Aktiv og neste fastvarepartisjon',
    runningPartition: 'Aktiv',
    runningSize: 'Aktiv størrelse',
    nextPartition: 'Neste oppdatering',
    nextSize: 'Oppdateringsstørrelse',
    webuiHint: 'Kilde og lagring for nytt design',
    source: 'Kilde',
    version: 'Versjon',
    partitionSize: 'Partisjonsstørrelse',
    used: 'Brukt',
    logs: 'Loggbuffer',
    logsHint: 'Minne, crash-tail og aktive direktestrømmer',
    capture: 'Opptak',
    active: 'Aktiv',
    inactive: 'Inaktiv',
    bufferSize: 'Bufferstørrelse',
    availableLogs: 'Lagrede logger',
    totalStream: 'Totalt skrevet',
    subscribers: 'Abonnenter',
    crashTail: 'Crash-tail',
    available: 'Tilgjengelig',
    notAvailable: 'Ikke tilgjengelig',
    onDemandHint: 'Alle verdier leses kun ved åpning eller manuell oppdatering. Den uavhengige nødsiden er tilgjengelig på',
    refresh: 'Oppdater'
  },
  ...
  updates: {
    ...
    title: 'Oppdateringer',
    subtitle: 'Fastvare og webgrensesnitt har separate versjoner og oppdateres uavhengig.',
    firmware: 'Fastvare',
    webui: 'WebUI',
    checkNow: 'Søk etter oppdateringer nå',
    checkingNow: 'Søker …',
    checkResultUpdatedTitle: 'Oppdatering tilgjengelig',
    checkResultUpdated: 'Versjon {version} er tilgjengelig.',
    checkResultNoUpdateTitle: 'Alt er oppdatert',
    checkResultNoUpdate: 'Ingen nyere versjon er tilgjengelig.',
    checkResultErrorTitle: 'Sjekk mislyktes',
    checkResultError: 'Oppdateringssjekken kunne ikke fullføres.',
    checkResultCooldownTitle: 'Et lite øyeblikk',
    checkResultCooldown: 'En sjekk pågår allerede, eller 60-sekunders-sperringen er fortsatt aktiv.',
    checkResultSkippedTitle: 'Sjekk hoppet over',
    checkResultSkipped: 'Enheten hoppet over sjekken på grunn av for lite ledig minne. Dette skjer vanligvis mens en CCU-økt er aktiv — prøv igjen senere.'
  },

  // WebUI-oppdateringsside (separat WebUI-fane)
  webuiUpdate: {
    pageTitle: 'Oppdater webgrensesnittet',
    pageSubtitle: 'Fastvare og WebUI har separate versjoner. Installasjonen skjer utelukkende via et manuelt valgt 320 KB WWW-bilde.',
    webuiChip: 'WebUI',
    firmwareChip: 'Fastvare',
    separateActive: 'Separat WebUI aktiv',
    embeddedFallback: 'Innebygd fallback aktiv',
    installedLabel: 'Installert WebUI-versjon',
    separateSource: 'Fra den separate WWW-partisjonen',
    embeddedSource: 'Innebygd i fastvaren',
    storageLabel: 'WWW-lagring',
    checkLabel: 'Oppdateringssjekk',
    checkHint: 'Online forespørsel høyst én gang i løpet av 24 timer',
    availableKicker: 'Tilgjengelig WebUI',
    downloadHeading: 'Last ned WebUI-fil',
    downloadHelp: 'ESP-en laster kun det lille felles oppdateringsmanifestet. BIN-filen lastes ned direkte av nettleseren din.',
    installedGridLabel: 'Installert',
    availableGridLabel: 'Tilgjengelig',
    imageSizeLabel: 'Bildestørrelse',
    minFirmwareLabel: 'Fastvare minimum',
    upToDate: 'Den installerte WebUI-en er oppdatert.',
    downloadButton: 'Last ned WebUI-BIN',
    releaseLink: 'Utgivelse på GitHub',
    reloadStatusButton: 'Last lagret status på nytt',
    manualKicker: 'Manuell installasjon',
    uploadHeading: 'Last opp WWW-bilde',
    uploadHelp: 'Bruk utelukkende webui_*.bin eller spiffs.bin med nøyaktig {size} her.',
    chooseFile: 'Velg WebUI-BIN',
    uploadInProgress: 'WebUI overføres …',
    uploadExplainer: 'Enheten sjekker partisjonsstørrelse, internt manifest og valgfritt SHA-256. Hvis bildet er ugyldig eller ufullstendig, forblir den innebygde New Design aktiv som fallback.',
    installingButton: 'WebUI installeres …',
    installButton: 'Installer WebUI',
    clearSelectionButton: 'Fjern valg',
    unknownVersion: 'ukjent',
    neverChecked: 'Ikke sjekket ennå',
    statusLoadError: 'Enhetsstatus kunne ikke lastes.',
    manifestNoWebui: 'Det lagrede oppdateringsmanifestet inneholder ennå ingen separat WebUI-fil.',
    manifestWrongDesign: 'Det oppgitte WebUI-bildet tilhører ikke New Design.',
    manifestWrongSize: 'Den tilbudte WebUI-en har feil størrelse. Forventet: {expected}.',
    manifestWrongApi: 'Denne WebUI-en krever en annen fastvare-API.',
    manifestFirmwareTooOld: 'Fastvaren er for gammel. Minimumskrav: {min}.',
    manifestLoadError: 'Lagret oppdateringsstatus kunne ikke lastes.',
    updateAvailableTitle: 'Oppdatering tilgjengelig',
    updateAvailableMessage: 'WebUI-versjon {version} er tilgjengelig.',
    skippedTitle: 'Sjekk hoppet over',
    skippedMessage: 'Enheten hoppet over sjekken på grunn av for lite ledig minne. Skjer vanligvis mens en CCU-økt er aktiv — prøv igjen senere.',
    upToDateTitle: 'Alt er oppdatert',
    upToDateMessage: 'Ingen nyere WebUI er tilgjengelig.',
    cooldownTitle: 'Et lite øyeblikk',
    cooldownMessage: 'En sjekk pågår allerede eller 60-sekunderssperringen er fortsatt aktiv.',
    checkFailedTitle: 'Sjekk mislyktes',
    checkFailedMessage: 'Oppdateringssjekken kunne ikke gjennomføres.',
    fileInvalidExtension: 'Ugyldig fil: et WebUI-bilde med filendelsen .bin kreves.',
    fileIsFirmware: 'Feil fil: dette er en fastvarefil. Installer den under System → Fastvare.',
    fileStatusMissing: 'Enhetsstatus utilgjengelig. Kjør først «Last lagret status på nytt» og prøv igjen.',
    fileWrongSize: 'Feil bildestørrelse: forventet nøyaktig {expected} ({bytes} byte).',
    installSuccessTitle: 'WebUI installert',
    installSuccessMessage: 'Aktiv WebUI-versjon: {version}',
    uploadFailedTitle: 'WebUI-opplasting mislyktes',
    uploadFailedMessage: 'WebUI-opplasting mislyktes.'
  },
  ...
  firmware: {
    ...
    factoryResetTitle: 'Fabrikkinnstillinger',
    factoryResetMessage: 'Vil du virkelig tilbakestille alle innstillinger til fabrikkinnstillinger?',
    factoryResetWarning: 'Alle lagrede innstillinger vil gå tapt. Enheten starter automatisk på nytt etterpå.',
    factoryResetConfirm: 'Tilbakestill til fabrikkinnstillinger',
    factoryResetError: 'Tilbakestilling til fabrikkinnstillinger mislyktes.',
    ...
    versionInfo: 'Modernisert fork v2.2.5-Beta.8 av Xerolux (2025) - Basert på originalarbeidet til Alexander Reinert.',
  ...
  monitoring: {
    ...
    resourceWarningTitle: 'Hold oversikt over ressursene',
    resourceWarningText: '{count} overvåkingstjenester er aktivert. ESP32 takler vanligvis dette, men samtidige TLS-tilkoblinger, fastvaresjekker/arkiv-henting og OTA deler heap og CPU; ved problemer, deaktiver enkelte tjenester eller forskyv tester.',
    save: 'Lagre',
    saving: 'Lagrer...',
  ...
  systemlog: {
    ...
    crashTitle: 'Krasjlogg gjenopprettet',
    crashHint: 'Enheten startet på nytt etter en watchdog-tilbakestilling eller systemfeil. Denne halen av de siste logglinjene ble lagret like før omstarten og vil ikke være tilgjengelig igjen etter lukking.'
  },
