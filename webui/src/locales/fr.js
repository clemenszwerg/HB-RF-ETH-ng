export default {
  ...
  systemOverview: {
    ...
    subtitle: 'RAM, flash, partitions, journaux et interface web active en un coup d’œil.',
    freeRam: 'RAM libre',
    usedRam: 'RAM utilisée',
    totalRam: 'RAM totale',
    minimumHeap: 'RAM minimale',
    largestBlock: 'Plus grand bloc',
    flash: 'Flash',
    currentAvailable: 'Disponible actuellement',
    allocatableRam: 'RAM interne disponible pour le tas',
    sinceBoot: 'Valeur la plus basse depuis le démarrage',
    contiguous: 'Plus grande allocation contiguë',
    physicalFlash: 'Stockage flash détecté',
    runtime: 'Environnement d’exécution',
    runtimeHint: 'ESP-IDF, matériel et dernier redémarrage',
    idf: 'ESP-IDF',
    target: 'Plateforme cible',
    cores: 'Cœurs CPU',
    chipRevision: 'Révision du chip',
    resetReason: 'Dernière raison de réinitialisation',
    psram: 'PSRAM',
    psramTotal: 'PSRAM totale',
    psramFree: 'PSRAM libre',
    partitions: 'Partitions OTA',
    partitionsHint: 'Partition firmware active et suivante',
    runningPartition: 'Actif',
    runningSize: 'Taille active',
    nextPartition: 'Prochaine mise à jour',
    nextSize: 'Taille de mise à jour',
    webuiHint: 'Source et stockage du nouveau design',
    source: 'Source',
    version: 'Version',
    partitionSize: 'Taille de partition',
    used: 'Utilisé',
    logs: 'Tampon de journal',
    logsHint: 'Mémoire, crash tail et flux en direct actifs',
    capture: 'Capture',
    active: 'Actif',
    inactive: 'Inactif',
    bufferSize: 'Taille du tampon',
    availableLogs: 'Journaux stockés',
    totalStream: 'Total écrit',
    subscribers: 'Abonnés',
    crashTail: 'Crash tail',
    available: 'Disponible',
    notAvailable: 'Non disponible',
    onDemandHint: 'Toutes les valeurs sont lues uniquement à l’ouverture ou lors d’une actualisation manuelle. La page d’urgence indépendante est disponible à',
    refresh: 'Actualiser'
  },
  ...
  updates: {
    ...
    title: 'Mises à jour',
    subtitle: 'Le micrologiciel et l\'interface web ont des versions distinctes et sont mis à jour séparément.',
    firmware: 'Micrologiciel',
    webui: 'WebUI',
    checkNow: 'Rechercher des mises à jour maintenant',
    ...
    checkResultCooldownTitle: 'Un instant',
    checkResultCooldown: 'Une vérification est déjà en cours ou le délai de 60 secondes est encore actif.',
    checkResultSkippedTitle: 'Vérification ignorée',
    checkResultSkipped: 'L\'appareil a ignoré la vérification en raison d\'une mémoire libre insuffisante. Cela se produit généralement pendant qu\'une session CCU est active — veuillez réessayer plus tard.'
  },
  ...
  webuiUpdate: {
    ...
    updateAvailableMessage: 'La version {version} de la WebUI est disponible.',
    skippedTitle: 'Vérification ignorée',
    skippedMessage: 'L\'appareil a ignoré la vérification faute de mémoire libre. Cela se produit généralement pendant qu\'une session CCU est active — veuillez réessayer plus tard.',
    upToDateTitle: 'Tout est à jour',
    upToDateMessage: 'Aucune WebUI plus récente disponible.',
    cooldownTitle: 'Un instant',
    cooldownMessage: 'Une vérification est déjà en cours ou le blocage de 60 secondes est encore actif.',
    checkFailedTitle: 'Vérification échouée',
    checkFailedMessage: 'La vérification de mise à jour n\'a pas pu être effectuée.',
  ...
  firmware: {
    ...
    versionInfo: 'Fork modernisé v2.2.5-Beta.8 par Xerolux (2025) - Basé sur le travail original d\'Alexander Reinert.',
