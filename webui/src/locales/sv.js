export default {
  ...
  firmware: {
    ...
    versionInfo: 'Moderniserad fork v2.2.3-Beta.8 av Xerolux (2025) - Baserad på originalarbetet av Alexander Reinert.',
  ...
  monitoring: {
    ...
    mqtt: {
      ...
      topicPrefixHelp: 'Standard: hb-rf-eth-ng - Ämnen kommer att vara som prefix/status/...',
