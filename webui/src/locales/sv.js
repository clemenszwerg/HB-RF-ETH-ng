export default {
  ...
  systemOverview: {
    ...
    subtitle: 'RAM, flash, partitioner, loggar och aktivt webbgränssnitt i en överblick.',
    freeRam: 'RAM ledigt',
    usedRam: 'RAM använt',
    totalRam: 'RAM totalt',
    minimumHeap: 'RAM-minimum',
    largestBlock: 'Största block',
    flash: 'Flash',
    currentAvailable: 'Tillgängligt nu',
    allocatableRam: 'Internt RAM tillgängligt för heapen',
    sinceBoot: 'Lägsta värde sedan start',
    contiguous: 'Största sammanhängande allokering',
    physicalFlash: 'Upptäckt flashminne',
    runtime: 'Körmiljö',
    runtimeHint: 'ESP-IDF, maskinvara och senaste omstart',
    idf: 'ESP-IDF',
    target: 'Målplattform',
    cores: 'CPU-kärnor',
    chipRevision: 'Chip-revision',
    resetReason: 'Senaste orsak till omstart',
    psram: 'PSRAM',
    psramTotal: 'PSRAM totalt',
    psramFree: 'PSRAM ledigt',
    partitions: 'OTA-partitioner',
    partitionsHint: 'Aktiv och nästa firmwarepartition',
    runningPartition: 'Aktiv',
    runningSize: 'Aktiv storlek',
    nextPartition: 'Nästa uppdatering',
    nextSize: 'Uppdateringsstorlek',
    webuiHint: 'Källa och lagring för ny design',
    source: 'Källa',
    version: 'Version',
    partitionSize: 'Partitionsstorlek',
    used: 'Använt',
    logs: 'Loggbuffert',
    logsHint: 'Minne, crash-tail och aktiva live-strömmar',
    capture: 'Inspelning',
    active: 'Aktiv',
    inactive: 'Inaktiv',
    bufferSize: 'Buffertstorlek',
    availableLogs: 'Sparade loggar',
    totalStream: 'Totalt skrivet',
    subscribers: 'Prenumeranter',
    crashTail: 'Crash-tail',
    available: 'Tillgängligt',
    notAvailable: 'Inte tillgängligt',
    onDemandHint: 'Alla värden läses endast vid öppning eller manuell uppdatering. Den oberoende nödsidan är tillgänglig på',
    refresh: 'Uppdatera'
  },
  ...
  webuiUpdate: {
    ...
    updateAvailableMessage: 'WebUI-version {version} är tillgänglig.',
    skippedTitle: 'Kontroll hoppades över',
    skippedMessage: 'Enheten hoppade över kontrollen på grund av för lite ledigt minne. Sker vanligtvis när en CCU-session är aktiv — försök igen senare.',
    upToDateTitle: 'Allt är uppdaterat',
    upToDateMessage: 'Ingen nyare WebUI är tillgänglig.',
    cooldownTitle: 'Ett litet ögonblick',
    cooldownMessage: 'En kontroll pågår redan eller spärren på 60 sekunder är fortfarande aktiv.',
    checkFailedTitle: 'Kontroll misslyckades',
    checkFailedMessage: 'Uppdateringskontrollen kunde inte genomföras.',
  ...
  firmware: {
    ...
    versionInfo: 'Moderniserad fork v2.2.5-Beta.8 av Xerolux (2025) - Baserad på originalarbetet av Alexander Reinert.',
