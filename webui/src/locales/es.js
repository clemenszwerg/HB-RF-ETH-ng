export default {
  ...
  settings: {
    ...
    ping: {
      ...
      target: 'Destino del ping (IP o nombre de host)',
      placeholder: '192.168.1.1',
      button: 'Ping',
      success: 'Ping exitoso. Latencia: {latency} ms',
      failure: 'Ping fallido o tiempo de espera agotado.'
    }
  },
  ...
  updates: {
    ...
    firmwareDescription: 'ESP32, red y radio',
    webui: 'WebUI',
    webuiDescription: 'Interfaz de control en el navegador',
